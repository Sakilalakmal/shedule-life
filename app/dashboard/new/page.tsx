...
import { createEventType } from "@/app/onboarding/actions";
...
export default function NewEventTypePage() {
  const [activePlatform, setActivePlatform] =
    useState<VideoCallProviderProps>("Google Meet");
  ...
  return (
    <div className="w-full h-full flex flex-1 items-center justify-center">
      <Card className="w-[500px]">
        <CardHeader>
          <CardTitle>Add new Appoinment</CardTitle>
          <CardDescription>
            create a new appointment that help people to book you
          </CardDescription>
        </CardHeader>
        <form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>
          ...
          <CardFooter className="mt-8 flex items-center gap-4">
            ...
            <SubmitButton text="create event" className="w-fit" />
          </CardFooter>
        </form>
      </Card>
    </div>
